...
{ label: "──",  title: "Dash",       latex: "\\rule[0.4ex]{1.2em}{0.9pt}" },
{ label: "───", title: "Long dash",  latex: "\\rule[0.4ex]{2.2em}{0.9pt}" },
  ]},
  { cols: 3, items: [
...
{ label: "⇆̅", latex: "\\begin{array}{c}\\xleftarrow{#?}\\\\[-6pt]\\xrightarrow{\\phantom{}}\\end{array}", icon: "leftrightarrows-over-template-image", title: "Left-Right Arrows with Text Above" },
{ label: "⇆̲", latex: "\\begin{array}{c}\\xleftarrow{\\phantom{}}\\\\[-6pt]\\xrightarrow[#?]{}\\end{array}", icon: "leftrightarrows-under-template-image", title: "Left-Right Arrows with Text Below" },
{ label: "⇆̲̅", latex: "\\begin{array}{c}\\xleftarrow{#?}\\\\[-6pt]\\xrightarrow[#?]{}\\end{array}", icon: "leftrightarrows-over-under-template-image", title: "Left-Right Arrows with Text Above and Below" },
...
TAB5_GROUPS = [
  ...
  { cols: 3, groupClass: "mr-tab5-fixed-matrix-group", cellWidth: 34, cellGap: 1, items: [
    ...
    { label: "[□\n□]", latex: "\\left[\\begin{matrix} #? \\\\ #? \\end{matrix}\\right]", icon: "matrix-vertical-square-template-image", title: "Column Matrix (Square Brackets)" },
    { label: "(□\n□)", latex: "\\left(\\begin{matrix} #? \\\\ #? \\end{matrix}\\right)", icon: "matrix-vertical-round-template-image", title: "Column Matrix (Parentheses)" },
  ...
  { cols: 2, groupClass: "mr-tab5-cases-group", cellWidth: 34, cellGap: 1, items: [
    { label: "{", latex: "\\begin{cases} #? \\\\ #? \\end{cases}", icon: "cases-left-template-image", title: "Left Cases" },
    { label: "f(x)", latex: "\\begin{cases} #? & #? \\\\ #? & #? \\end{cases}", icon: "cases-piecewise-template-image", title: "Piecewise Function" },
    { label: "}", latex: "\\left.\\begin{matrix} #? \\\\ #? \\end{matrix}\\right\\}", icon: "cases-right-template-image", title: "Right Cases" },
